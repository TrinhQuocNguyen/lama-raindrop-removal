...
def video2video(input_video_path, out_video_path, frame=30, w=1920, h=1080):
    cap = cv2.VideoCapture(input_video_path)
    n = 0
    # write video
    fourcc = cv2.VideoWriter_fourcc(*'MP4V')
...
def demo_video_2(path_01, path_02, output_video, text_01="", text_02="", vertical=False, fps= 30, with_arrow = False,
                 arrow_path = "", with_logo = False, logo_path = "", resized = False, w0=1920, h0=1080):
    dir_files = os.listdir(path_01)
    dir_files.sort()
...
def alpha_blending(input_folder_path, output_images_path,
    ...
    for file_inter in dir_files:
        ...
        cv2.imwrite(output_images_path + "/" + "eye_" +'{0:06}'.format(n)+'_mask.png', outImage)
        n += 1
        # cv2.waitKey(1)
...
if __name__ == '__main__':
    ...
    # video2video("D:/tmp/GOPR1031_new_512_blended_02/170/demo_tokyo/02.Tokyo_recovery_demo.mp4",
    #             "D:/tmp/GOPR1031_new_512_blended_02/170/demo_tokyo/004.Tokyo_recovery_demo_HD_cut.MOV", 15, 1080, 720)
    ...
    #
    # video2images("C:/Users/Trinh/Downloads/30fps_4X_120fps_2.mp4",
    #            "C:/Users/Trinh/Downloads/30fps_4X_120fps_2")

    # images2video("C:/Users/Trinh/Downloads/30fps_4X_120fps_22.mp4",
    #              "C:/Users/Trinh/Downloads/30fps_4X_120fps_2", 5, 1280, 960)

    # images2video("C:/Users/Trinh/Downloads/30fps_4X_120fps_22.mp4",
    #              "C:/Users/Trinh/Downloads/realesrgan-ncnn-vulkan-20210801-windows/input", 5, 1280, 960)

    # images2images("//192.168.111.170/mnt/AIProjects/trinh/DATA/ksc_data/train/input",
    #              "//192.168.111.170/mnt/AIProjects/trinh/DATA/ksc_data_512/train/cloudy_image", 512, 512)

    # fix_video_format("C:/Users/Trinh/Downloads/road_01_out.mp4","C:/Users/Trinh/Downloads",1,30, 1280, 720)
    # video2video("C:/Users/Trinh/Downloads/InHARD_demo.mp4", "C:/Users/Trinh/Downloads/InHARD_demo2.mp4", 30, 842, 480)
    # video2video("C:/Users/Trinh/Downloads/combination/scene.MP4", "C:/Users/Trinh/Downloads/combination/scene_nor.mp4", 30, 1920, 1080)


    # crop_and_save("C:/Users/Trinh/Downloads/vis_eyes_samplemovie", "C:/Users/Trinh/Downloads/New_folder_3", 313,147,1324,916)
    ...
    # super_hero.cloning_images("raindrop/mask_collection/mask_03.png", "raindrop/input_and_mask", 4730)
    # alpha_blending("raindrop/input_and_mask",
    #                "raindrop/masked",
    #                "raindrop/mask_collection/mask_03.png")

    demo_video_2(
        "raindrop/masked",
        "raindrop/output",
        "raindrop/demo_20220308.mp4",
        "",
        "",
        vertical=False,
    )
    ...
    # video2images("D:/[DATA]/raindrop_koiwa/koiwa.mp4", "D:/[DATA]/raindrop_koiwa/input", 1)
    ...
    # video2images(
    #     "C:/Users/Trinh/Downloads/combination/scene.MP4",
    #     "C:/Users/Trinh/Downloads/combination/scene")
